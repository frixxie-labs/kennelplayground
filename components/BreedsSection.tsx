...
export function BreedsSection() {
  return (
    <section class="bg-[#211814] py-16 text-white">
...
function BreedCard({ id, label, title, description }: BreedCardProps) {
  return (
    ...
    >
      <p class="text-sm font-semibold uppercase tracking-[0.2em] text-[#d7b18c]">
        {label}
      </p>
      <h2 class="mt-3 text-3xl font-semibold tracking-[-0.03em] md:text-4xl">
        {title}
      </h2>
      <p class="mt-5 text-lg leading-8 text-white/70">{description}</p>
    </article>
  );
}
